...
//    self.tabBarController.viewControllers = @[timelineNavigationController, popularNavigationController,newPostNavigationController, searchNavigationController, nearbyNavigationController, profileNavigationController];
    self.tabBarController.viewControllers = @[timelineNavigationController, popularNavigationController,newPostNavigationController, searchNavigationController,  profileNavigationController];
    ...
    UITabBarItem *popularTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Explorer" image:[[UIImage imageNamed:@"tabbar-popular"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"tabbar-popular"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    UITabBarItem *searchTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Search" image:[[UIImage imageNamed:@"tabbar-searchuser"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"tabbar-searchuser"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
