...
- (void)viewDidLoad {
    ...
    self.tabBar.barTintColor = [UIColor colorWithRed:255/255.0f green:0/255.0f blue:0/255.0f alpha:1.0f];
...
- (void)showTerms {
    WLIPrivacyViewController *PrivacyViewController = [[WLIPrivacyViewController alloc] initWithNibName:@"WLIPrivacyViewController" bundle:nil];
    UINavigationController *PrivacyNavigationViewController = [[UINavigationController alloc] initWithRootViewController:PrivacyViewController];
    PrivacyNavigationViewController.navigationBar.translucent = NO;
    [self presentViewController:PrivacyNavigationViewController animated:YES completion:^{ }];
}
