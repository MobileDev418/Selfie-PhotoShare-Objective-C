...
-(void) savebuttonClick:(UIButton*)sender
{
   ...
   UIImageWriteToSavedPhotosAlbum(self.theImageView.image, self, @selector(imageSavedToPhotosAlbum: didFinishSavingWithError: contextInfo:), Nil);
...
- (void)imageSavedToPhotosAlbum:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *)contextInfo {
    ...
    if (!error) {
        ...
        message = NSLocalizedString(@"This photo have just saved Successfully on your PhotoAlbum!", @"");
    } else {
...
-(void)loadView {
    ...
    self.zoomeableScrollView.scrollEnabled = NO;
}
...
- (void) showImageFrom:(UIImageView*) imageView {
    ...
    button.frame = CGRectMake([[UIScreen mainScreen]bounds].size.width-70, 20.0, 100.0, 40.0);
